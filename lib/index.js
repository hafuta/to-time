...
(function() {
    ...
    var TimeFrame = (function TimeFrame() {
        function TimeFrame(seconds) {
            this.val = seconds;
        }

        //Converters
        TimeFrame.prototype.ms = TimeFrame.prototype.milliseconds = function ms() {
            return this.val * MILLISECONDS_IN_SECOND;
        };

        TimeFrame.prototype.seconds = TimeFrame.prototype.second = function seconds() {
            return this.val;
        };

        TimeFrame.prototype.minutes = TimeFrame.prototype.minute = function minutes() {
            return this.val / SECONDS_IN_MINUTE;
        };

        TimeFrame.prototype.hours = TimeFrame.prototype.hour = function hours() {
            return this.val / SECONDS_IN_HOUR;
        };

        TimeFrame.prototype.days = TimeFrame.prototype.day = function days() {
            return this.val / SECONDS_IN_DAY;
        };

        TimeFrame.prototype.weeks = TimeFrame.prototype.day = function weeks() {
            return this.val / SECONDS_IN_WEEK;
        };

        TimeFrame.prototype.years = TimeFrame.prototype.year = function years() {
            return this.val / SECONDS_IN_YEAR;
        };

        //Appenders
        TimeFrame.prototype.addSeconds = function(seconds) {
            this.val += seconds;
            return this;
        };

        TimeFrame.prototype.addMinutes = function(minutes) {
            this.val += minutes * SECONDS_IN_MINUTE;
            return this;
        };

        TimeFrame.prototype.addHours = function(hours) {
            this.val += hours * SECONDS_IN_HOUR;
            return this;
        };

        TimeFrame.prototype.addDays = function(days) {
            this.val += days * SECONDS_IN_DAY;
            return this;
        };

        TimeFrame.prototype.addWeeks = function(weeks) {
            this.val += weeks * SECONDS_IN_WEEK;
            return this;
        };

        TimeFrame.prototype.addYears = function(years) {
            this.val += years * SECONDS_IN_YEAR;
            return this;
        };

        TimeFrame.prototype.addMilliseconds = function(milliseconds) {
            this.val += milliseconds * SECONDS_IN_MILLISECOND;
            return this;
        };

        //Formaters
        TimeFrame.prototype.humanize = function humanize() {
            var val = this.val;
    ...
    var toTime = (function() {
        function toTime(text) {
            ...
            units.w = units.week = units.weeks = SECONDS_IN_WEEK;
        ...
        toTime.fromMilliseconds = function(milliseconds) {
            return new TimeFrame(milliseconds * SECONDS_IN_MILLISECOND);
        };
        ...
        toTime.fromMinutes = function(minutes) {
            return new TimeFrame(minutes * SECONDS_IN_MINUTE);
        };

        toTime.fromHours = function(hours) {
            return new TimeFrame(hours * SECONDS_IN_HOUR);
        };

        toTime.fromDays = function(days) {
            return new TimeFrame(days * SECONDS_IN_DAY);
        };

        toTime.fromWeeks = function(weeks) {
            return new TimeFrame(weeks * SECONDS_IN_WEEK);
        };

        toTime.fromYears = function(years) {
            return new TimeFrame(years * SECONDS_IN_YEAR);
        };
